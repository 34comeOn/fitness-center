...
var tabsListElement = document.querySelector('.subscription__tab-list'); // const videoElement = document.querySelector('.about__video');
...
videoContainerElement.addEventListener('click', function () {
  if (!videoCoverElement.classList.contains('visually-hidden')) {
    videoCoverElement.classList.add('visually-hidden'); // playVideo(videoElement);
  }
});
