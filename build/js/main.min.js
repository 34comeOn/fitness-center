...
var mainWrapperElement = document.querySelector('.wrapper');
var videoCoverElement = document.querySelector('.about__video-cover');
var videoContainerElement = document.querySelector('.about__video-container');
var tabsContainerElement = document.querySelector('.subscription__button-list');
var tabsListElement = document.querySelector('.subscription__tab-list');
var videoElement = document.querySelector('.about__video');
var leftArrowElement = document.querySelector('.feedback__button-left');
var rightArrowElement = document.querySelector('.feedback__button-right');
var nameInputElement = document.querySelector('input[name="name"]');
var phoneInputElement = document.querySelector('input[name="phone"]');
var submitButtonElement = document.querySelector('.form__button');
var coachesContainerElement = document.querySelector('.coaches__slides');
var leftCoachButtonElement = document.querySelector('.coaches__button-left');
var rightCoachButtonElement = document.querySelector('.coaches__button-right');
var nameInputRe = /[A-Za-zA-Яа-яЁё0-9\s]$/;
var phoneInputRe = /^((8|\+7)[\- ]?)?(\(?\d{3}\)?[\- ]?)?[\d\- ]{1,10}$/;
var collectionOfComments = document.querySelectorAll('.feedback__slide');
...
var isSpaceKey = function isSpaceKey(evt) {
  return evt.key === ' ';
};

var onLabelSpaceKeydown = function onLabelSpaceKeydown(evtSpaceKeydown) {
...
tabsContainerElement.addEventListener('click', function (evt) {
  if (!evt.target.classList.contains('subscription__button-tab--active') && evt.target.classList.contains('subscription__button-tab')) {
    ...
    document.getElementById("".concat(evt.target.id, "-subscription")).classList.add('subscription__card-list--active');
  }
});
...
glide.mount();
var feedback = new _glidejs_glide__WEBPACK_IMPORTED_MODULE_0__["default"]('.glide--feedback', {
  type: 'slider',
  perView: 1
});
feedback.mount();
...
coachesContainerElement.addEventListener('keydown', function (evt) {
  var cardsCollection = coachesContainerElement.querySelectorAll('.coaches__info-wrapper');

  if (evt.target.classList.contains('coaches__info-wrapper')) {
    var _iterator = _createForOfIteratorHelper(cardsCollection),
        _step;
    ...
    var _iterator2 = _createForOfIteratorHelper(cardsCollection),
        _step2;
...
var handleFocusListener = function handleFocusListener(element) {
  element.addEventListener('focus', function () {
    coachesContainerElement.classList.add('coaches__arrows-active');
  });
};

var handleBlurListener = function handleBlurListener(element) {
...
var validateInput = function validateInput(element, re, text) {
  element.addEventListener('input', function () {
    var nameInputArray = element.value.split(' ');

    if (element.value.endsWith(' ')) {
      nameInputArray.pop();
    }

    var booleanNameInputArray = nameInputArray.map(function (nameValidity) {
      return re.test(nameValidity);
    });
    nameInputArray.forEach(function (word) {
